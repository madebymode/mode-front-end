...
<body>
    ...
    <main class="o-section  /  u-max-width-640  /  u-margin-horizontal-auto  /  u-padding-horizontal-sm  u-padding-horizontal-md@sm" role="main">
        ...
        <section class="u-margin-bottom">
            <h3 class="u-margin-bottom-xs  /  u-color-gray-1  /  u-font-size-100%">
                Color and white-space
            </h3>
            <p class="u-display-none@lt-md  /  u-margin-bottom">
        ...
        <section class="u-margin-bottom">
            ...
            <p class="u-display-none@md  /  u-margin-bottom">
                Visible on mobile.
            </p>
        </section>
        ...
        <section class="u-margin-bottom">
            ...
            <div class="u-display-flex  /  u-flex-wrap-nowrap  /  u-align-items-center">
                <span class="u-flex-0  /  u-padding-right-sm">
        ...
        <section class="o-grid  o-grid--gutters">
            ...
            <p class="o-grid__item  u-width-1/1  u-width-1/2@md  /  u-margin-bottom">
